...
def prophet_predict(train, dates, changepoint_prior_scale, seasonality_mode, seasonality_prior_scale):
...
def main(store, product):
    ...
    if prophet_best:
        ...
        prophet_model_full = Prophet(
            ...
            seasonality_prior_scale=prophet_best["params"]["seasonality_prior_scale"],
        )
